...
def get_structure_graph(structure: Structure, bonding_kwargs: dict = {}, bonding_algorithm: NearNeighbors= EconNN):
    structure_graph = StructureGraph.with_local_env_strategy(structure=structure,
